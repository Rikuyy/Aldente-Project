...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String _name = 'Budi';
  List<Tag> _favFoods = [
    const Tag('Pedas', FontAwesomeIcons.pepperHot),
    const Tag('Ayam', FontAwesomeIcons.drumstickBite),
    const Tag('Gurih', FontAwesomeIcons.utensils)
  ];
  List<Tag> _allergies = [const Tag('Kacang', FontAwesomeIcons.seedling)];
  String _budgetCycle = 'Mingguan';
  List<Tag> _missingTools = [
    const Tag('Oven', FontAwesomeIcons.fire),
    const Tag('Blender', FontAwesomeIcons.blender)
  ];
  int _eatFrequency = 3;

  final _allFavFoods = [
    const Tag('Pedas', FontAwesomeIcons.pepperHot),
    const Tag('Manis', FontAwesomeIcons.candyCane),
    const Tag('Gurih', FontAwesomeIcons.utensils),
    const Tag('Asin', FontAwesomeIcons.mortarPestle),
    const Tag('Ayam', FontAwesomeIcons.drumstickBite),
    const Tag('Sapi', FontAwesomeIcons.cow),
    const Tag('Seafood', FontAwesomeIcons.fish),
    const Tag('Sayuran', FontAwesomeIcons.carrot)
  ];
  final _allAllergies = [
    const Tag('Kacang', FontAwesomeIcons.seedling),
    const Tag('Susu', FontAwesomeIcons.whiskeyGlass),
    const Tag('Telur', FontAwesomeIcons.egg),
    const Tag('Seafood', FontAwesomeIcons.fish),
    const Tag('Gluten', FontAwesomeIcons.breadSlice),
    const Tag('Kedelai', FontAwesomeIcons.seedling)
  ];
  final _allTools = [
    const Tag('Kompor', FontAwesomeIcons.fire),
    const Tag('Oven', FontAwesomeIcons.fire),
    const Tag('Microwave', FontAwesomeIcons.radiation),
    const Tag('Blender', FontAwesomeIcons.blender),
    const Tag('Rice Cooker', FontAwesomeIcons.bowlRice),
    const Tag('Kulkas', FontAwesomeIcons.snowflake)
  ];
          ...
          SliverAppBar(
            ...
            leading: IconButton(
              icon: const Icon(Icons.chevron_left,
                  size: 28, color: AppTheme.slate500),
              onPressed: () => context.pop(),
            ),
            title: const Text('Profil DNA',
                style: TextStyle(
                    fontSize: 20,
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color:
                                _isEditing ? Colors.white : AppTheme.orange600,
                          ),
                        ),
                      ],
                    ),
              ...
              delegate: SliverChildListDelegate([
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                                ...
                                borderSide: const BorderSide(
                                    color: AppTheme.slate200, width: 2)),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Text('Frekuensi Makan Sehari',
                            style: TextStyle(
                                fontWeight: FontWeight.w900,
                                color: AppTheme.slate800)),
                      ],
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    child: const Text('Keluar dari CookCase+',
                        style: TextStyle(
      ...
      children: [
        Row(
          children: [
            ...
            Text(title,
                style: const TextStyle(
                    fontWeight: FontWeight.w900, color: AppTheme.slate800)),
          ],
        ),
          ...
          Container(
            ...
            child: Text(emptyText,
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.w700,
                    color:
                        emptyIsGood ? AppTheme.green600 : AppTheme.slate400)),
          )
        else
          Wrap(
            spacing: 8,
