...
class _Recommendation {
  ...
  final Color color;
  final Color bgColor;
  const _Recommendation({required this.icon, required this.name, required this.category, required this.estimasi, required this.color, required this.bgColor});
}
...
class _HomePageState extends State<HomePage> {
  ...
  static const _categories = ['Semua', 'Masak Sendiri', 'Sarapan', 'Makan Siang', 'Makan Malam'];

  static const _allRecommendations = [
    _Recommendation(icon: Icons.restaurant_rounded,    name: 'Nasi Goreng Telur',    category: 'Masak Sendiri', estimasi: 'Rp 8.000',  color: AppTheme.orange500, bgColor: AppTheme.orange50),
    _Recommendation(icon: Icons.lunch_dining_rounded,  name: 'Mie Nyemek Pedas',     category: 'Masak Sendiri', estimasi: 'Rp 5.000',  color: AppTheme.red500,    bgColor: AppTheme.red50),
    _Recommendation(icon: Icons.outdoor_grill_rounded, name: 'Ayam Bakar Kecap',     category: 'Makan Malam',   estimasi: 'Rp 12.000', color: AppTheme.green600,  bgColor: AppTheme.green50),
    _Recommendation(icon: Icons.egg_rounded,           name: 'Telur Dadar Sayur',    category: 'Sarapan',       estimasi: 'Rp 4.000',  color: AppTheme.orange400, bgColor: AppTheme.orange50),
    _Recommendation(icon: Icons.rice_bowl_rounded,     name: 'Nasi Uduk Sederhana',  category: 'Sarapan',       estimasi: 'Rp 6.000',  color: AppTheme.blue500,   bgColor: AppTheme.blue50),
    _Recommendation(icon: Icons.ramen_dining_rounded,  name: 'Soto Ayam Kuah',       category: 'Makan Siang',   estimasi: 'Rp 10.000', color: AppTheme.purple600, bgColor: AppTheme.purple50),
  ];

static const _stockReminders = [
  _StockReminder(id: '1', name: 'Telur Ayam',    type: ReminderType.lowStock,    icon: Icons.egg_rounded,              iconColor: AppTheme.orange400, currentQty: 2,   maxQty: 12,   unit: 'butir', daysAgo: 1, maxDays: 7),
  _StockReminder(id: '2', name: 'Dada Ayam',     type: ReminderType.expiringSoon, icon: Icons.lunch_dining_rounded,     iconColor: AppTheme.orange500, currentQty: 250, maxQty: 500,  unit: 'gram',  daysAgo: 5, maxDays: 7),
  _StockReminder(id: '3', name: 'Tomat',         type: ReminderType.expiringSoon, icon: Icons.spa_rounded,              iconColor: AppTheme.red500,    currentQty: 2,   maxQty: 6,    unit: 'pcs',   daysAgo: 4, maxDays: 5),
  _StockReminder(id: '4', name: 'Minyak Goreng', type: ReminderType.lowStock,    icon: Icons.opacity_rounded,          iconColor: AppTheme.blue500,   currentQty: 200, maxQty: 1000, unit: 'ml',    daysAgo: 2, maxDays: 30),
];
  ...
  List<_StockReminder> get _expiringReminders =>
      _stockReminders.where((s) => s.type == ReminderType.expiringSoon).toList();
                            ...
                            if (unreadCount > 0)
                              Positioned(top: -6, right: -6,
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(color: AppTheme.orange500, borderRadius: BorderRadius.circular(50), border: Border.all(color: context.colors.cardBackground, width: 1.5)),
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Stack(children: [
                        Positioned(top: -24, right: -24, child: Container(width: 110, height: 110, decoration: const BoxDecoration(color: Color(0x0FFFFFFF), shape: BoxShape.circle))),
                        Positioned(bottom: -16, left: -16, child: Container(width: 80, height: 80, decoration: const BoxDecoration(color: Color(0x08FFFFFF), shape: BoxShape.circle))),
                        Padding(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(color: const Color(0x1AFFFFFF), borderRadius: BorderRadius.circular(50), border: Border.all(color: const Color(0x1AFFFFFF))),
                            ...
                            ClipRRect(
                              ...
                              child: const LinearProgressIndicator(value: 0.20, minHeight: 5, backgroundColor: Color(0x1AFFFFFF), valueColor: AlwaysStoppedAnimation<Color>(AppTheme.orange400)),
                            ),
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected ? AppTheme.orange500 : context.colors.cardBackground,
                            borderRadius: BorderRadius.circular(50),
                            border: Border.all(color: isSelected ? AppTheme.orange500 : context.colors.border, width: 1.5),
                          ),
                          child: Text(_categories[i], style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: isSelected ? Colors.white : context.colors.textSecondary)),
                        ),
                      );
                    },
                  ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [_topRec.color.withValues(alpha: 0.12), _topRec.color.withValues(alpha: 0.03)],
                            begin: Alignment.topLeft, end: Alignment.bottomRight,
                          ),
                          borderRadius: BorderRadius.circular(24),
                          border: Border.all(color: _topRec.color.withValues(alpha: 0.2)),
                        ...
                        child: Row(children: [
                          Container(
                            width: 72, height: 72,
                            decoration: BoxDecoration(
                              color: _topRec.color, shape: BoxShape.circle,
                              boxShadow: [BoxShadow(color: _topRec.color.withValues(alpha: 0.4), blurRadius: 16, offset: const Offset(0, 6))],
                            ),
                            child: Icon(_topRec.icon, color: Colors.white, size: 34),
                          ),
                          const SizedBox(width: 16),
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Container(
                              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                              decoration: BoxDecoration(color: _topRec.color, borderRadius: BorderRadius.circular(50)),
                              child: const Text('Pilihan Terbaik dari Kita', style: TextStyle(color: Colors.white, fontSize: 9, fontWeight: FontWeight.w700, letterSpacing: 0.3)),
                            ),
                            const SizedBox(height: 6),
                            Text(_topRec.name, style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16, color: context.colors.textPrimary, letterSpacing: -0.4)),
                            const SizedBox(height: 4),
                            Text(_topRec.category, style: TextStyle(fontSize: 11, color: context.colors.textSecondary, fontWeight: FontWeight.w600)),
                            const SizedBox(height: 8),
                            Row(children: [
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                decoration: BoxDecoration(color: AppTheme.green50, borderRadius: BorderRadius.circular(50)),
                                child: Row(mainAxisSize: MainAxisSize.min, children: [
                                  const Icon(Icons.payments_rounded, size: 10, color: AppTheme.green600),
                                  const SizedBox(width: 3),
                                  Text(_topRec.estimasi, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: AppTheme.green600)),
                                ]),
                              ),
                            ]),
                          ])),
                          Icon(Icons.chevron_right_rounded, color: _topRec.color, size: 24),
                        ]),
                      ),
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return Padding(
                          padding: EdgeInsets.only(right: 12, left: i == 0 ? 20 : 0),
                          child: GestureDetector(
                            onTap: () => context.go('/app/consultation'),
                            child: Container(
                              padding: const EdgeInsets.all(16),
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Row(children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: rec.bgColor, borderRadius: BorderRadius.circular(50)),
                                    child: Text(rec.category, style: TextStyle(fontSize: 9, fontWeight: FontWeight.w700, color: rec.color)),
                                  ),
                                ]),
                                ...
                                Row(children: [
                                  ...
                                  const Spacer(),
                                  Icon(Icons.arrow_forward_ios_rounded, size: 11, color: context.colors.textHint),
                                ]),
                              ]),
                            ),
                          ),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('Reminder Stok', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: context.colors.textPrimary, letterSpacing: -0.5)),
                    GestureDetector(
                      onTap: () => context.go('/app/inventory'),
                      child: const Text('Lihat Stok', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppTheme.orange600)),
                    ),
                  ]),
                ),
                ...
                if (_lowStockReminders.isNotEmpty || _expiringReminders.isNotEmpty)
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: Container(
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Container(
                          ...
                          child: const Icon(Icons.inventory_2_rounded, color: AppTheme.red500, size: 18),
                        ),
                        const SizedBox(width: 10),
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(
                            '${_lowStockReminders.length + _expiringReminders.length} item perlu perhatian',
                            style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 13, color: AppTheme.red600),
                          ),
                          const SizedBox(height: 2),
                          Text(
                            '${_lowStockReminders.length} stok menipis · ${_expiringReminders.length} akan kedaluarsa',
                            style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppTheme.red500.withValues(alpha: 0.8)),
                          ),
                        ])),
                        GestureDetector(
                          onTap: () => context.go('/app/inventory'),
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: AppTheme.red500, borderRadius: BorderRadius.circular(50)),
                            child: const Text('Cek', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.white)),
                          ),
                        ),
                      ]),
                    ),
                ...
                if (_lowStockReminders.isNotEmpty) ...[
                  Padding(
                    ...
                    child: Row(children: [
                      Container(width: 8, height: 8, decoration: const BoxDecoration(color: AppTheme.orange500, shape: BoxShape.circle)),
                      const SizedBox(width: 8),
                      Text('Stok Menipis', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: context.colors.textSecondary, letterSpacing: 0.3)),
                      const SizedBox(width: 8),
                  ...
                  ..._lowStockReminders.map((s) => Padding(
                    ...
                    child: _StockReminderCard(reminder: s, onTap: () => context.go('/app/inventory')),
                  )),
                ],
                ...
                if (_expiringReminders.isNotEmpty) ...[
                  Padding(
                    padding: const EdgeInsets.fromLTRB(20, 4, 20, 8),
                    child: Row(children: [
                      Container(width: 8, height: 8, decoration: const BoxDecoration(color: AppTheme.red500, shape: BoxShape.circle)),
                      const SizedBox(width: 8),
                      Text('Segera Kedaluarsa', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: context.colors.textSecondary, letterSpacing: 0.3)),
                      const SizedBox(width: 8),
                      Expanded(child: Divider(color: context.colors.border)),
                    ]),
                  ),
...
class _StockReminderCardState extends State<_StockReminderCard> with SingleTickerProviderStateMixin {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: _expanded ? accentColor.withValues(alpha: 0.3) : context.colors.border),
          boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.04), blurRadius: 8, offset: const Offset(0, 2))],
        ),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(r.name, style: TextStyle(fontWeight: FontWeight.w800, fontSize: 14, color: context.colors.textPrimary)),
              const SizedBox(height: 2),
              Text(
                isLow
            ...
            Container(
              ...
              child: Text(
                isLow ? '${(r.stockPercent * 100).toInt()}%' : '${r.daysLeft}h lagi',
            ...
            AnimatedRotation(
              ...
              child: Icon(Icons.keyboard_arrow_down_rounded, size: 20, color: context.colors.textHint),
            ),
          ]),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text(
                        ...
                        style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: context.colors.textHint),
                      ),
                      Text(
                        isLow
                            ? '${r.currentQty.toInt()} / ${r.maxQty.toInt()} ${r.unit}'
                            : 'Hari ke-${r.daysAgo} dari ${r.maxDays}',
                        style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: context.colors.textSecondary),
                      ),
                    ]),
                    const SizedBox(height: 6),
                    ClipRRect(
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  icon: Icon(isLow ? Icons.add_shopping_cart_rounded : Icons.inventory_2_rounded, size: 16),
