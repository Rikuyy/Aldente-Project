  ...
  void _handleRegister() async {
    if (_passwordController.text != _confirmPasswordController.text) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Password confirmation match failed")));
      return;
    }
...
const userIcon =
    '''<svg width="15" height="18" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.40822 9.13158C4.52444 9.13158 2.18191 6.78905 2.18191 3.90526C2.18191 1.02148 4.52444 -1.32105 7.40822 -1.32105C10.292 -1.32105 12.6345 1.02148 12.6345 3.90526C12.6345 6.78905 10.292 9.13158 7.40822 9.13158ZM7.40822 7.90789C9.61877 7.90789 11.4108 6.11586 11.4108 3.90526C11.4108 1.69467 9.61877 -0.0973684 7.40822 -0.0973684C5.19763 -0.0973684 3.4056 1.69467 3.4056 3.90526C3.4056 6.11586 5.19763 7.90789 7.40822 7.90789ZM1.1969 11.3918C2.56947 10.3624 4.25418 9.75 6.08224 9.75H8.73421C10.5623 9.75 12.247 10.3624 13.4196 11.3918C14.6548 12.4762 15.3586 13.9785 15.3586 15.5658V16.3224C15.3586 17.1654 14.6753 17.8487 13.8322 17.8487H0.984211C0.141158 17.8487 -0.542105 17.1654 -0.542105 16.3224V15.5658C-0.542105 13.9785 0.161632 12.4762 1.3969 11.3918H1.1969ZM1.19163 12.355C0.370526 13.0762 -0.125 14.1843 -0.125 15.3816V16.1382C-0.125 16.751 0.371368 17.2474 0.984211 17.2474H13.8322C14.4451 17.2474 14.9414 16.751 14.9414 16.1382V15.3816C14.9414 14.1843 14.4459 13.0762 13.6248 12.355C12.3789 11.2608 10.6385 10.6184 8.73421 10.6184H6.08224C4.17792 10.6184 2.4375 11.2608 1.19163 12.355Z" fill="#757575"/></svg>''';
const googleIcon =
