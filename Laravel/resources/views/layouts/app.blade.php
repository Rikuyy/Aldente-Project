    ...
    <div class="flex h-screen w-full relative">
        ...
        <aside class="flex flex-col bg-neutral-950 border-r border-neutral-800 shrink-0 z-20 w-72">
            ...
            <nav class="flex-1 mt-6 space-y-2 overflow-y-auto overflow-x-hidden flex flex-col px-4">
                ...
                <a href="{{ url('/api-tester') }}" wire:navigate
                   class="flex items-center rounded-xl transition-colors duration-200 {{ request()->is('api-tester') ? 'bg-[#FF723A]/10 text-[#FF723A] border border-[#FF723A]/20 font-bold' : 'text-neutral-400 border border-transparent hover:text-white hover:bg-neutral-800 font-medium' }} w-full px-4 py-3 justify-start">
                    <svg class="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                    </svg>
                    <span class="ml-3 whitespace-nowrap">API Tester</span>
                </a>
