              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: const [
                        ...
                        SizedBox(height: 8),
                        Text('Selamat Makan! 🍲', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: -0.5), textAlign: TextAlign.center),
                        SizedBox(height: 4),
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        _IngredientRow(name: 'Telur Ayam', subtitle: 'Sisa: 5 butir', change: '-1 btr'),
                        const SizedBox(height: 10),
                        _IngredientRow(name: 'Bawang Merah', subtitle: 'Sisa: 80g', change: '-20g'),
