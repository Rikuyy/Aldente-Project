              ...
              children: [
                _BotMessage(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Halo Budi! 👋', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 14, color: AppTheme.slate900, letterSpacing: -0.3)),
                ...
                const SizedBox(height: 12),
                _UserMessage(text: 'Tolong cari resep dari bahan yang ada'),
                const SizedBox(height: 12),
                _BotMessage(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
